...
export const Header: React.FC<HeaderPropsType> = ({ isCarousel, headerImages, headerHeight, romanHeaderMessage, italizedHeaderMessage }) => {
    return (
        <HeaderWrapper
            height={headerHeight}
        >
                        ...
                        return (
                            ...
                            >
                                <Typography
                                    ...
                                    fontWeight={500}
                                    fontSize={{ mobile: "28px", tablet: "42px", laptop: "52px", desktop: "64px" }}
                                    lineHeight={"normal"}
                                ...
                                >
                                    {romanHeaderMessage} <Typography
                                        ...
                                        fontWeight={400}
                                        fontSize={{ mobile: "32px", tablet: "40px", laptop: "60px", desktop: "80px", xl: "95px" }}
                                        lineHeight={"inherit"}
                                        color={"inherit"}
                                        textAlign={"inherit"}
                                        whiteSpace={"inherit"}
